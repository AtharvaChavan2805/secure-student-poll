...
interface WalletConnectionProps {
  onConnect: (studentData: { name: string; email: string; studentId: string }) => Promise<any>;
  onAdminLogin: (password: string) => Promise<boolean>;
  isConnecting?: boolean;
}

export const WalletConnection = ({ onConnect, onAdminLogin, isConnecting }: WalletConnectionProps) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/20 to-primary/10 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="flex justify-center space-x-2 mb-6">
          ...
          <Button
            variant={isAdminMode ? "admin" : "outline"}
            size="sm"
        ...
        {!isAdminMode ? (
          <Card className="shadow-card-custom bg-gradient-card border-primary/20">
          ...
          <Card className="shadow-card-custom bg-gradient-card border-blockchain-dark/20">
            <CardHeader className="text-center">
              <CardTitle className="flex items-center justify-center gap-2">
              ...
              <form onSubmit={handleAdminLogin} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-blockchain-dark/20 focus:border-blockchain-dark"
                  />
